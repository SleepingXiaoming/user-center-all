...
var FieldRadio = function FieldRadio(_ref, ref) {
  ...
  var _useStyle = useStyle('checkbox', function (token) {
    return _defineProperty({}, ".".concat(layoutClassName, "-horizontal"), _defineProperty({}, "".concat(token.antCls, "-radio-wrapper"), {
      display: 'block',
      marginInlineEnd: 0
    }));
  }),
  ...
  if (mode === 'edit') {
    ...
    var RadioComponents = radioType === 'button' ? Radio.Button : Radio;

    var _dom = wrapSSR(_jsx(Radio.Group, _objectSpread(_objectSpread({
      ref: radioRef
    }, rest.fieldProps), {}, {
      className: classNames((_rest$fieldProps = rest.fieldProps) === null || _rest$fieldProps === void 0 ? void 0 : _rest$fieldProps.className, hashId, "".concat(layoutClassName, "-").concat(rest.fieldProps.layout || 'vertical')),
      options: undefined,
