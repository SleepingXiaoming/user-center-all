...
var GlobalHeader = function GlobalHeader(props) {
  ...
  var className = classNames(propClassName, baseClassName, hashId, _defineProperty({}, "".concat(baseClassName, "-layout-").concat(layout), layout && headerTheme === 'dark'));
  ...
  var logoClassNames = classNames("".concat(baseClassName, "-logo"), hashId, (_classNames2 = {}, _defineProperty(_classNames2, "".concat(baseClassName, "-logo-rtl"), direction === 'rtl'), _defineProperty(_classNames2, "".concat(baseClassName, "-logo-mix"), layout === 'mix'), _defineProperty(_classNames2, "".concat(baseClassName, "-logo-mobile"), isMobile), _classNames2));
