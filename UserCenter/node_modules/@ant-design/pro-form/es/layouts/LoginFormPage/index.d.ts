...
export declare function LoginFormPage<T = Record<string, any>>(props: Partial<LoginFormPageProps<T>>): React.ReactElement<any, string | React.JSXElementConstructor<any>>;
